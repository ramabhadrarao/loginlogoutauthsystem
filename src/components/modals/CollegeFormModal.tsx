...
import { X, Building, Mail, Phone, Globe, MapPin, Image as ImageIcon } from 'lucide-react';
          ...
          <div className="relative w-full max-w-lg transform overflow-hidden rounded-lg bg-white shadow-xl transition-all">
            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {/* Logo Selection */}
                <FormField id="logo" label="College Logo" error={errors.logo}>
